...
**Bahdanau, Gontier, Huang et al. (ServiceNow)** · [arXiv:2412.08445](https://arxiv.org/abs/2412.08445)
...
### LangChain
**[github.com/langchain-ai/langchain](https://github.com/langchain-ai/langchain)** — 95k+ stars *(as of early 2025)*
...
### LangGraph
**[github.com/langchain-ai/langgraph](https://github.com/langchain-ai/langgraph)** — 12k+ stars *(as of early 2025)*
...
### AutoGen (Microsoft)
**[github.com/microsoft/autogen](https://github.com/microsoft/autogen)** — 40k+ stars *(as of early 2025)*
...
### CrewAI
**[github.com/crewAIInc/crewAI](https://github.com/crewAIInc/crewAI)** — 40k+ stars *(as of early 2025)*
...
### DSPy (Stanford)
**[github.com/stanfordnlp/dspy](https://github.com/stanfordnlp/dspy)** — 22k+ stars *(as of early 2025)*
...
**[github.com/microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel)** — 23k+ stars *(as of early 2025)*
...
### Haystack (deepset)
**[github.com/deepset-ai/haystack](https://github.com/deepset-ai/haystack)** — 18k+ stars *(as of early 2025)*
...
One orchestrator agent routes tasks to specialist agents. The hub maintains context; spokes are stateless workers. Used in [HuggingGPT](https://arxiv.org/abs/2303.17580), many LangGraph workflows.
...
Tasks requiring multi-step reasoning, tool use, and common sense. Humans achieve 92%; GPT-4+plugins achieved ~15% at release ([arXiv:2311.12983](https://arxiv.org/abs/2311.12983)). Tests true general-purpose assistant ability.
...
- **MetaGPT: Meta Programming for A Multi-Agent Collaborative Framework** (Hong et al., 2023) — [arXiv:2308.00352](https://arxiv.org/abs/2308.00352)
...
- **AgentVerse: Facilitating Multi-Agent Collaboration and Exploring Emergent Behaviors** (Chen et al., 2023) — [arXiv:2308.10848](https://arxiv.org/abs/2308.10848)
- **DyLAN: Towards Dynamic LLM-Agent Network Deployed at the Edge** (Liu et al., 2023) — [arXiv:2310.02170](https://arxiv.org/abs/2310.02170)
- **Solo Performance Prompting** (Wang et al., 2023) — [arXiv:2307.05300](https://arxiv.org/abs/2307.05300)
- **AgentScope: A Flexible yet Robust Multi-Agent Platform** (Alibaba, 2024) — [arXiv:2402.14034](https://arxiv.org/abs/2402.14034)
- **TapeAgents: Tape-Centric Agent Framework** (Bahdanau et al., 2024) — [arXiv:2412.08445](https://arxiv.org/abs/2412.08445)
...
### Blog Posts & Articles
- **Anthropic: Building Effective Agents** — [anthropic.com/engineering/multi-agent-research-system](https://www.anthropic.com/engineering/multi-agent-research-system)
...
- **DSPy** (Stanford) — [github.com/stanfordnlp/dspy](https://github.com/stanfordnlp/dspy)
- **Semantic Kernel** (Microsoft) — [github.com/microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel)
- **Haystack** (deepset) — [github.com/deepset-ai/haystack](https://github.com/deepset-ai/haystack)
- **Agno** — [github.com/agno-agi/agno](https://github.com/agno-agi/agno)
- **OpenAI Swarm** — [github.com/openai/swarm](https://github.com/openai/swarm)
- **CAMEL** — [github.com/camel-ai/camel](https://github.com/camel-ai/camel)
...
- **AgentVerse** — [github.com/OpenBMB/AgentVerse](https://github.com/OpenBMB/AgentVerse)

### Standards & Specifications
- **Model Context Protocol (MCP)** (Anthropic, 2024) — [modelcontextprotocol.io](https://modelcontextprotocol.io)
