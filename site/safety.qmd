...
Benchmark for indirect prompt injection attacks on tool-calling agents. Tests 30+ attack patterns. Most models are highly vulnerable, especially to indirect attacks embedded in tool outputs.
...
- **stereOS** (papercompute.co) — NixOS-based OS hardened for agent sandboxing
- **AgentFS** (Turso) — auditable, reproducible agent filesystem
...
| **InjecAgent** | Indirect prompt injection (30+ patterns) | Most models highly vulnerable |
...
| **Gartner Prediction (2024)** | Project cancellations | 40%+ of agentic AI projects predicted cancelled by 2027 due to cost/safety |
