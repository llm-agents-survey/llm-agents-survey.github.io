...
::: {.callout-note}
## Editorial synthesis
The five dimensions below are an editorial synthesis for this survey, not a taxonomy from a single source. They draw primarily from [Wang et al. (2023)](https://arxiv.org/abs/2308.11432) (Brain/Perception/Memory/Action/Planning), [Plaat et al. (2025)](https://arxiv.org/abs/2503.23037) (Reason/Act/Interact), and [Sumers et al. (2023)](https://arxiv.org/abs/2309.02427) (cognitive memory architecture), combined with common framings in the practitioner literature. The goal is a practical map of design choices rather than a formal taxonomy.
:::
...
|---------|-------------|---------|
| **Single** | One LLM does everything | Standard [ReAct](https://arxiv.org/abs/2210.03629) agents |
| **Specialist pipeline** | Sequential specialization | HuggingGPT, modular agents |
| **Peer collaboration** | Agents debate and refine | [CAMEL](https://arxiv.org/abs/2303.17760), SPP |
| **Hierarchical** | Manager + workers | [AutoGen](https://arxiv.org/abs/2308.08155), [MetaGPT](https://arxiv.org/abs/2308.00352), [ChatDev](https://arxiv.org/abs/2307.07924) |
| **Society** | Many autonomous agents | [Generative Agents](https://arxiv.org/abs/2304.03442), [AgentVerse](https://arxiv.org/abs/2308.10848) |
...
Key papers: [Plan-and-Execute](https://arxiv.org/abs/2305.04091) (Chase, 2023; [blog post](https://blog.langchain.dev/plan-and-execute-agents/)), [LLM+P](https://arxiv.org/abs/2304.11477), [DEPS](https://arxiv.org/abs/2302.01846)
