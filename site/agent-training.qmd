...
[**SkyRL-Agent**](https://arxiv.org/abs/2511.16108) (Cao et al., 2025) is an open framework for scalable RL training of multi-turn LLM agents. It provides a unified tool interface, efficient rollout scheduling, and dynamic trajectory construction—addressing the engineering bottleneck that makes RL for agents much harder than RL for single-turn reasoning. SkyRL-Agent trains primarily on SWE (software engineering) tasks but demonstrates generalization to Terminal-Bench, BrowseComp-Plus, and WebArena.
...
- **Small LMs for Agentic Tool Calling (2024)** — [arXiv:2512.15943](https://arxiv.org/abs/2512.15943) — fine-tuned SLM outperforms ChatGPT on ToolBench.
...
- [**Nexusflow/NexusRaven-13B**](https://huggingface.co/Nexusflow/NexusRaven-13B) — function calling model on HuggingFace.
